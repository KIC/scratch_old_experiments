package yusugomori.RBM;

/**
 * Created by kic on 26.03.15.
 */
...
public class RBM implements Serializable {
    ...
    public RBM(int window, int predict, int quantiles, int N, int n_visible, int n_hidden, double[][] W, double[] hbias, double[] vbias, Random rng, boolean weekly) {
        this.window = window;
